 ...
 * Copyright (c) 2009-2011 by pingoGame, Inc. All Rights Reserved.
...
//@interface pingoGameObject : NSObject
//@end

@interface pingoGameObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[pingoGameObject class]])
		{
			for (NSString *key in [[(pingoGameObject*)o modules] allKeys])
			{

...
@interface pingoGameObject : KrollCoverageObject {
#else
@interface pingoGameObject : KrollObject {
#endif
@private
...
extern NSString * pingoGame$ModuleRequireFormat;

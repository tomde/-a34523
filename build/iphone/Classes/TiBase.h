...
// in simulator we redefine to format for pingoGame Developer console
...
{\
	NSString * exceptionName = [@"org.pingogame." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pingogame";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIpingoGameNativeItemNone = -1, 
	UIpingoGameNativeItemSpinner = -2,
	UIpingoGameNativeItemProgressBar = -3,
	
	UIpingoGameNativeItemSlider = -4,
	UIpingoGameNativeItemSwitch = -5,
	UIpingoGameNativeItemMultiButton = -6,
	UIpingoGameNativeItemSegmented = -7,
	
	UIpingoGameNativeItemTextView = -8,
	UIpingoGameNativeItemTextField = -9,
	UIpingoGameNativeItemSearchBar = -10,
	
	UIpingoGameNativeItemPicker = -11,
	UIpingoGameNativeItemDatePicker = -12,
	
	UIpingoGameNativeItemInfoLight = -13,
	UIpingoGameNativeItemInfoDark = -14,
	
	UIpingoGameNativeItemDisclosure = -15,
	
	UIpingoGameNativeItemContactAdd = -16
};
